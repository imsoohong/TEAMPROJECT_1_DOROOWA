...
<head>
  ...
  <title>수강생 회원가입</title>
    <link rel="stylesheet" href="${contextPath }/css/member/Member_Total.css">
  	...
  	<script defer src="${contextPath }/js/member/studentJoinForm.js"></script>
</head>
...
<body>
  <div id="container">
    <div class="form-wrap">
      <h1>수강생 회원가입</h1>
      <form action="${contextPath }/student/studentJoin" id="joinForm" method="post">
