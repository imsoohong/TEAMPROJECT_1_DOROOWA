		...
		<div class="main">
			...
			<div class="recommendation">
				<div class="recommend__left">
					<h2>Doroowa 클래스</h2>
					<h2>${newReviewCnt }건의 최신 후기</h2>
						<h5>베어유의 최신 수강후기를 공개합니다.<br>
						수강후기를 통해 먼저 강의에 대한 내용을 파악하고 결정하세요.</h5>
				...
				<ul class="recommendation__content">
					<c:forEach var="rec" items="${newReviewList }">
						<li class="recommendation__text">
							...
							</c:choose> ${rec.rcontent.substring(0,40)}... 
							...
							<button class="recommend__button"
								onclick="location.href='${contextPath}/offlinelectures/list/전체' ">Doroowa의 더 많은 클래스 보기</button>
			</div>
		</div>
	</div>
			<!-- footer -->
