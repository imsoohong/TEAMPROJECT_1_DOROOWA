...
<% 
	...
	String confmKey = "devU01TX0FVVEgyMDIxMDMxNjE4MzAwODExMDkyNzk="; // 검색API 승인키
...
%>
<script type="text/javascript" src="/doroowa/js/jquery-1.12.4.min.js"></script>
<script type="text/javascript" src="/doroowa/js/addrlink.js"></script>
<link rel="stylesheet" type="text/css" href="/doroowa/css/addrlink.css"></link>
