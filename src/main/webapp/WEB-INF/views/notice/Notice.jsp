...
<!-- 자바스크립트 -->
<script defer src="${contextPath }/js/notice/Notice.js"></script>
</head>
				...
				<!-- 글쓰기버튼 (관리자만) -->
				  ...
				  <div>
					  <ul class="pagination pagination-sm justify-content-center" >
					    ...
					    <!-- 첫 페이지 -->
					    <li class="page-item">
					    	<a class="page-link" href="${contextPath }/notice/1/">처음</a>
					    </li>	
					    <!-- 이전 페이지 -->		
					    <li class="page-item">
					    	<a class="page-link" href="${contextPath }/notice/${pc.startPage-1}">이전</a>
					    </li>	
					    </c:if>
					    ...
					    <c:if test="${pageNum eq pc.rc.reqPage}">
 					    <li class="page-item active" aria-current="page">
								<a class="page-link" href="${contextPath }/notice/${pageNum}">${pageNum }</a>
					    </li>
					    </c:if>
					    ...
					    <!-- 다음페이지 -->
					    <li class="page-item">
					    	<a class="page-link" href="${contextPath }/notice/${pc.endPage + 1}">다음</a>
					    </li>	
					    <!-- 최종페이지 -->		
					    <li class="page-item">
					    	<a class="page-link" href="${contextPath }/notice/${pc.finalEndPage}">최종</a>
					    </li>	
					    </c:if>
					  </ul>
					</div>
